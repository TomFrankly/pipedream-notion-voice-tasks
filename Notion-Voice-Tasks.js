	...
	async additionalProps() {
		...
		const props = {
			...
			...(this.source && {
				source_value: {
					type: "string",
					label: `Source Value (for chosen property: ${this.source})`,
					description:
			...
			...(this.status && {
				status_value: {
					type: "string",
					label: `Status Value (for chosen property: ${this.status})`,
					description:
						"Choose a value for your chosen Status property. If you don't choose a Status value, your database's default value will be used.",
					options: this.status
