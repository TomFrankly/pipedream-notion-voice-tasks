...
export default defineComponent({
	props: {
		...
		openai: {
			type: "app",
			app: "openai",
			description: `Enter your OpenAI API key. If you don't have one, [create one here.](https://platform.openai.com/account/api-keys) If you don't have an OpenAI account, create one first and enter your billing details.`,
		},
		secretKey: {
			type: "string",
			label: "Secret Key",
